                    ...
                    <div className="col-md-6">
                        <section>
                            ...
                            <form className="form-register-login" onSubmit={handleSubmit}>
                                <label className="label-register-login" htmlFor="username">
                                    Username:
                                ...
                                <label className="label-register-login" htmlFor="password">
                                    Password:
                                ...
                                <label className="label-register-login" htmlFor="confirm_pwd">
                                    Confirm Password:
                            ...
                            <p>
                                ...
                                <a href="/login"><h1 className="already-registered-text"> Log In</h1></a>
                                {/* </span> */}
                            </p>
                        </section>
